                      ...
                      <body>
                          ...
                          <div class="container">
                            ...
                            <form class="form-signin" action="logincheck.php" method="post">
                              ...
                              <input type="password" class="input-block-level" placeholder="Password" style="color:black;" name="password">
                              <input type="submit" name="submit" value="SIGN IN" style="color:black;"/>
                            </form>
